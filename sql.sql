...
(
    citizen_id int not null auto_increment primary key ,
     citizen_name  varchar(50) null,
     state_id int not null , 
    constraint fk_citizen_state foreign key (state_id) references states (state_id),

     city_id int not null  , 
       constraint fk_citizen_cities foreign key (city_id) references cities (city_id),

     citizen_mob varchar(12) null ,
     citizen_email varchar(200) null unique key, 
     address varchar(300) null 
);
Alter table raj_hackathon add otp varchar(5);

insert into citizens(citizen_name,state_id,citizen_email,citizen_mob) value ("yashit" , 15,"yashitagfeagjsh@gmaiul.com", "7089859806");
...
alter table citizens modify city_id int null;
